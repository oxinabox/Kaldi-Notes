...
##Data Splitting.
The data splitting is carried out by the `run.sh` script, rather than by the `local/tidigits_data_prep.sh` script. It can however be carried out at anytime after the trainingc and test directories are created.
